  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-8 w-8 items-center justify-center rounded-md text-lg text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-600 dark:text-zinc-500 dark:hover:bg-zinc-700 dark:hover:text-zinc-300"
        title="插入 emoji"
      >
        😊
      </button>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Emoji 网格 */}
          <div className="h-[280px] overflow-y-auto p-2 [scrollbar-width:thin] [scrollbar-color:rgb(161_161_170)_transparent] dark:[scrollbar-color:rgb(82_82_91)_transparent] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-zinc-300 [&::-webkit-scrollbar-track]:bg-transparent dark:[&::-webkit-scrollbar-thumb]:bg-zinc-600">
